    ...
    public static class WebApplicationBuilderExtensions
    {
        public static void ConfigureDbConfiguration(this WebApplicationBuilder builder)
        {
            builder.Host.ConfigureAppConfiguration((hostCtx, configBuilder) =>
            {
                ...
                //string connStr = configRoot.GetValue<string>("DefaultDB:EnglishLearning");
                string connStr = builder.Configuration.GetValue<string>("DefaultDB:EnglishLearning");
        ...
        public static void ConfigureExtraServices(this WebApplicationBuilder builder, InitializerOptions initOptions)
        {
            ...
            services.AddAllDbContexts(ctx =>
            {
                ...
                //因此这里推荐放到环境变量中。
                string connStr = configuration.GetValue<string>("DefaultDB:EnglishLearning");
